...
5. Import the shipped profile from [../Samples/](../Samples/) via `Profiles: Import Profile...`.
...
- The shipped starter profile in `Samples/` is exactly what you would build live - we just give it to you.
