...
3. Show that the Extensions tab is empty initially - this is the "fresh install" baseline before section 02.

## Gotchas

- "UI State" includes things like panel layout and view visibility. A profile remembers the editor *shape*, not just the configuration.
